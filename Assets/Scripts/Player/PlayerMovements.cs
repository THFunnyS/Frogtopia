...
public class PlayerMovements : MonoBehaviour
{
    ...
    private bool isArmorSkin = true; //бронированн€ кожа
    private float armorResist = 1f;
    private float armorTime = 5f;
    private float armorCooldown = 10f;

    public GameObject PoisonCloud; //€довитое облоко
    ...
    private void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.F)) //скиллы тела жабы
        {
            ...
            //if (isPoisonCloud) StartCoroutine(PoisonCloudSkill()); //€довитое облако
        }
    ...
    private IEnumerator PoisonCloudSkill() //€довитое облако
    {
